...
public class ArraysUtility {
    ...
    public static double[] merge(double[] arr1, double[] arr2) {
        ...
        double[] arr3 = new double[arr1.length + arr2.length]; //to combine 2 arrays, so it can have enough capacity
    ...
    public static char[] merge(char[] arr1, char[] arr2) {
        ...
        char[] arr3 = new char[arr1.length + arr2.length]; //to combine 2 arrays, so it can have enough capacity
    ...
    public static String[] merge(String[] arr1, String[] arr2) {
        ...
        String[] arr3 = new String[arr1.length + arr2.length]; //to combine 2 arrays, so it can have enough capacity
