...
public class CollectionsUtilityMethods {
    ...
    public static void main(String[] args) {
        ...
        list.addAll(Arrays.asList(10,20,20,30,40,50,50,50,40,60));
        int count = Collections.frequency(list,50);
        System.out.println(count); //3 "50" in the array
        ...
        numbers.addAll(Arrays.asList(10,20,20,30,40,50,50,50,40,60,60,50,50,50));

        for (Integer each : numbers) {
            if(Collections.frequency(numbers,each) == 1){ //unique if it equals to 1
